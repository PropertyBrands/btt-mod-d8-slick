...
/**
 * @file
 * Contains Drupal\slick\Controller\SlickSettingsList.
 */

namespace Drupal\slick\Controller;

use Drupal\Core\Config\Entity\ConfigEntityListBuilder;
use Drupal\Core\Entity\EntityInterface;

/**
 * Provides a listing of all Slideshow Settings for Slick.
 *
 ...
 *
 * @package Drupal\slick\Controller
 *
 * @ingroup slick
 */
class SlickSettingsList extends ConfigEntityListBuilder {
  ...
  public function render() {
    $build['description'] = array(
      '#markup' => $this->t("<p>Here you can create groups of slideshow settings"
        . " for the Slick module. This is a list of the settings groups currently"
        . " available for use in Views and Fields.</p>"),
    );
    $build[] = parent::render();
    return $build;
  }
