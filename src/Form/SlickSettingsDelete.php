...
/**
 * @file
 * Contains Drupal\slick\Form\SlickSettingsDelete.
 */
...
/**
 * Class SlickSettingsDelete.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from SlickSettingsbase. The reason for
 ...
 * @ingroup slick
 */
class SlickSettingsDelete extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete %label?', array(
  ...
  public function getConfirmText() {
    return $this->t('Delete Slideshow Settings');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message(t('Slideshow settings for %label have been deleted.', array(
      '%label' => $this->entity->label(),
    )));
